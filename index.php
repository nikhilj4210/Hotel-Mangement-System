...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:krishnasp369@gmail.com">KRISHNASP369@GMAIL.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9901620022</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">NIX<span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dream Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">NIX HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our NIX HOTEL</h3> 
...
<!-- //gallery -->
  ...
  <!-- visitors -->
	<div class="w3l-visitors-agile" >
		<div class="container">
                 <h3 class="title-w3-agileits title-black-wthree">What our visitors experienced</h3> 
		</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9901620022</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:krishnasp369@gmail.com">KRISHNASP369@GMAIL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> SDM Institute of Technology,Ujire</p>
			...
			<iframe src="https://www.google.com/maps/place/SDM+Institute+of+Technology/@12.9899101,75.3399145,16.85z/data=!4m12!1m6!3m5!1s0x3ba4c9d62fe87bc3:0x229a721cca7f29e5!2sSDM+Institute+of+Technology!8m2!3d12.9899836!4d75.3410026!3m4!1s0x3ba4c9d62fe87bc3:0x229a721cca7f29e5!8m2!3d12.9899836!4d75.3410026" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 NIX HOTEL | Design by <a href="index.php">KRISHNA PATIL & NIKHIL J</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
